      ...
      <div className="mt-4">
        ...
        {status === 'Applied' ? (
          <div className='flex gap-2 mt-4'>
            <button onClick={() => changeStatus('Rejected')} className='flex-grow-1 text-base button rejected'>Reject</button>
            <button onClick={() => changeStatus('Accepted')} className='flex-grow-1 text-base button accepted'>Accept</button>
          </div>
        )
        : (
          <div className='align-items-center flex gap-2 mt-4'>
            <p>{status}</p>
            <button onClick={() => changeStatus('Applied')} className='text-base button'>Restore</button>
          </div>
        )}
      </div>
    </Layout>
